...
| 步骤 | API | Endpoint |
|------|-----|----------|
| 1. 创建任务 | 图生视频 - 创建任务 | POST `https://app-bset9i1icp35-api-DY8MN3QBydBa-gateway.appmiaoda.com/v1/videos/image2video` |
| 2. 查询单个任务 | 图生视频 - 查询任务（单个） | GET `https://app-bset9i1icp35-api-zYkZzgKook1L-gateway.appmiaoda.com/v1/videos/image2video/{id}` |
| 3. 查询任务列表 | 图生视频 - 查询任务（列表） | GET `https://app-bset9i1icp35-api-n9QVoDJ6oykL-gateway.appmiaoda.com/v1/videos/image2video` |
