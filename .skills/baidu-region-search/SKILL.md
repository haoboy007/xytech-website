...
| 属性 | 值 |
|------|---|
| Endpoint | `GET https://app-bset9i1icp35-api-DYJwn2VZXvEa-gateway.appmiaoda.com/api_region_search/v1/` |
...
async function queryAdminRegion(
  ...
  const response = await fetch(
    `https://app-bset9i1icp35-api-DYJwn2VZXvEa-gateway.appmiaoda.com/api_region_search/v1/?${params.toString()}`,
    {
      method: "GET",
      headers: {
