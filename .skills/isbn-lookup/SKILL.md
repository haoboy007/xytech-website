...
- **Endpoint**：`POST https://app-bset9i1icp35-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-bset9i1icp35-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
